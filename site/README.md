...
This directory contains the accessible browser laboratory for Fairshift Lab v0.3.0. It mirrors the documented synthetic process so visitors can explore shift mechanisms, source-only temperature scaling, reliability, complete decision-threshold curves, group measurements, and sampling uncertainty without installing Python.
